...
BOAST_KERNEL(write_seismograms_transfer_scalar_from_device_kernel);
...
BOAST_KERNEL(outer_core_impl_kernel);
BOAST_KERNEL(inner_core_impl_kernel);
...
BOAST_KERNEL(crust_mantle_impl_kernel);
