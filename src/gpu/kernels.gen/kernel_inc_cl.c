...
#include "write_seismograms_transfer_scalar_from_device_kernel_cl.c"
...
#include "outer_core_impl_kernel_cl.c"
#include "inner_core_impl_kernel_cl.c"
...
#include "crust_mantle_impl_kernel_cl.c"
